...
Command: npx gltfjsx@6.1.11 public/models/Avatarlean.glb
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function Avatarlean(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./models/Avatarlean.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature" rotation={[Math.PI / 2, 0, 0]} scale={0.95}>
...
useGLTF.preload('./models/Avatarlean.glb')
