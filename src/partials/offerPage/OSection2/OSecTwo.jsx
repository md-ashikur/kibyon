...
const OSecTwo = () => {
  ...
  return (
    <div className="px-5 lg:py-20 bg-primary text-center text-white">
      <h1 className="text-4xl font-bold  my-5">Notre méthode</h1>
      <Swiper
        effect={"coverflow"}
        grabCursor={true}
        centeredSlides={true}
      ...
      >
        <SwiperSlide>
          <div className="rounded-lg  bg-gradient-to-t from-[#080E1A]  to-[#1A3D5F]  ">
            ...
            <img src={img1} alt="" className="!w-[300px] !h-[300px]" />
