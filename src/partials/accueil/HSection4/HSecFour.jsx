...
const HSecFour = () => {
  ...
  return (
    <div className="relative">
      <div className="absolute text-justify top-0 z-10 lg:px-20">
      <section class="container">
        <div class="content lg:!w-[35%] mt-52">
        <p className="">
 ...
 {/* ==========•	Appear frame 100==========3rd part================ */}
    <section class="container">
       ...
       <p className="lg:!w-[35%]">
        ...
        <div className="lg:!w-[35%] lg:mt-52">
        <p >
  ...
  {/* ========•	Appear frame 350==========3rd part=================== */}
    <section class="container">
        <div class="content lg:!w-[35%] mt-20">
        <p className="">
