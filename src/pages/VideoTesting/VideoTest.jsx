...
return (
<div>
<div className="upar-menu">
<i className="ri-close-fill"></i>
<div className="left-upar-menu">
<h1 id="abhishek">Home</h1>
<h1 id="amarjeet">About</h1>
<h1 id="rk">Order</h1>
<h1 id="ak">Contact</h1>
</div>
</div>
<div id="main-again">
  ...
  <div id="main2">
    ...
    <div className="txt-home modern">
      <div className="h-container">
        <h1>
        <span className="txt1">Welcome to</span>
              <span className="txt2">VideoTest</span>
              <span className="txt3">React App</span>
            </h1>
          </div>
        </div>
      </div>
